...
class ServerInfoCog(Cog, name="Server Information"):
    ...
    async def server(self, ctx: Context):
        ...
        embed.add_field(name=t.cnt_members(guild.member_count), value=t.cnt_online(online_count))
        ...
        embed.add_field(name=t.cnt_bots(len(bots)), value=t.cnt_online(bots_online))
    ...
    async def server_bots(self, ctx: Context):
        ...
        guild: Guild = ctx.guild
        embed = Embed(title=t.bots, color=Colors.ServerInformation)
        online: List[Member] = []
        offline: List[Member] = []
